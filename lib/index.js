...
exports.DataGovernanceValues = exports.makeConsoleLogger = void 0;
var configcat_common_1 = require("configcat-common");
var RolloutEvaluator_1 = require("configcat-common/lib/RolloutEvaluator");
...
function clientAutoPoll(sdkKey, cache, options) {
    return configcat_common_1.createClientWithAutoPoll(sdkKey, { configFetcher: new ConfigFetcher_1.HttpConfigFetcher(), cache: cache }, options);
}
/**
...
function clientManualPoll(sdkKey, cache, options) {
    return configcat_common_1.createClientWithManualPoll(sdkKey, {
 ...
 * @param logLevel
 */
function makeConsoleLogger(logLevel) {
    return configcat_common_1.createConsoleLogger(logLevel);
}
exports.makeConsoleLogger = makeConsoleLogger;
exports.DataGovernanceValues = {
    /** Select this if your feature flags are published to all global CDN nodes. */
    Global: configcat_common_1.DataGovernance.Global,
    /** Select this if your feature flags are published to CDN nodes only in the EU. */
    EuOnly: configcat_common_1.DataGovernance.EuOnly,
};
var VueConfigcat = {
    install: function (Vue, vueOptions) {
        ...
        //         : 60;
        var evaluator = new RolloutEvaluator_1.RolloutEvaluator(options ? options.logger : configcat_common_1.createConsoleLogger(-1));
        var configcatCache = new Cache_1.LocalStorageCache(onCacheUpdate);
        var configcatClient;
        switch (POLLING_MODE) {
            // case "lazy":
